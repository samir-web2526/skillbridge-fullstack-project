...
router.get("/", auth(userRole.STUDENT, userRole.TUTOR, userRole.ADMIN), bookingController.getBooking);
router.get("/:bookingId", auth(userRole.STUDENT, userRole.TUTOR, userRole.ADMIN), bookingController.getBookingById);
